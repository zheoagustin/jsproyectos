...
switch (solicitud) {
    ...
    default: 
    alert("No hay seleccionado ninguna opcion correcta, Ingrese nuevamente")
    console.log("No ha seleccionado ninguna opcion correcta");
        break;
}
...
if (solicitud === 1) {
    alert("Se ha agendado un turno en "+ opcion1.especializacion +" en el " + opcion1.hospital + ", Muchas gracias por su tiempo")
} else if (solicitud === 2) {
    alert("Se ha agendado un turno en "+ opcion2.especializacion +" en el " + opcion2.hospital + ", Muchas gracias por su tiempo")
} else if (solicitud === 3) {
    alert("Se ha agendado un turno en "+ opcion3.especializacion +" en el " + opcion3.hospital + ", Muchas gracias por su tiempo")
} else if (solicitud === 4) {
    alert("Se ha agendado un turno en "+ opcion4.especializacion +" en el " + opcion4.hospital + ", Muchas gracias por su tiempo")
}
